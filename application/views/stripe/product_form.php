...
<head>
    ...
    <script type="text/javascript">
        ...
        Stripe.setPublishableKey('pk_test_BG3B795ufY1LeRwBXTK4SNp6');
            ...
            <div class="card">
                ...
                <div class="card-body bg-light">
                    ...
                    <div id="payment-errors"></div>  
                     <form method="post" id="paymentFrm" enctype="multipart/form-data" action="<?php echo base_url(); ?>stripe_test/check">
